...
real(double_precision), allocatable, dimension(:) :: branching_ratio2 !< dim(nb_reactions) Branching ratio of each reaction
...
allocate(branching_ratio2(nb_reactions))
branching_ratio2(1:nb_reactions) = 0.d0
